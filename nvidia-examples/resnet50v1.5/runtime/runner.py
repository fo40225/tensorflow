...
class Runner(object):
    ...
    @staticmethod
    def _get_session_config(mode, allow_xla):
    ...
    @staticmethod
    def _get_run_config(mode, model_dir, allow_xla, seed=None):
        ...
        config = tf.estimator.RunConfig(
            ...
            session_config=Runner._get_session_config(mode=mode, allow_xla=allow_xla),
    ...
    def _get_estimator(self, mode, run_params, allow_xla):
